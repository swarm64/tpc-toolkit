...
from swarm64_tpc_toolkit import correctness
...
def test_check_correctness_no_correctness_file(cc, mocker):
    ...
    mocked_filepath = mocker.patch('swarm64_tpc_toolkit.correctness.Correctness.get_correctness_filepath')
...
def test_check_correctness_mismatch(cc, monkeypatch_read_csv, monkeypatch_to_html, mocker):
    ...
    mocked_os_join = mocker.patch('swarm64_tpc_toolkit.correctness.os.path.join')
