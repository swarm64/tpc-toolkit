...
CREATE TABLE nation_prt_{{ remainder }}
PARTITION OF nation FOR VALUES WITH (MODULUS {{ modulus }}, REMAINDER {{ remainder }});

CREATE TABLE region_prt_{{ remainder }}
PARTITION OF region FOR VALUES WITH (MODULUS {{ modulus }}, REMAINDER {{ remainder }});
...
CREATE TABLE supplier_prt_{{ remainder }}
PARTITION OF supplier FOR VALUES WITH (MODULUS {{ modulus }}, REMAINDER {{ remainder }});
